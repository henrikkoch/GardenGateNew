...
extern enum STATE_DOOR_STATES state_door;
...
# 162 "main.c"
    ...
    MDCARHbits.MDCH = 0b0100;
    MDCONbits.MDEN = 0;
    MDSRCbits.MDMSODIS = 1;
    ...
    MDSRCbits.MDMS = 0b0010;
    MDCARHbits.MDCH = 0b0100;
    MDCARLbits.MDCL = 0b0100;
    ...
    DoorStateBeforePrel = PORTAbits.RA2;
    ...
    switch (PORTAbits.RA2) {
        case 1:
             state_door = STATE_DOOR_OPEN;
             OPTION_REGbits.INTEDG = !1;
             NewDoorPolarity = 1;
             DoorStateBeforePrel = 1;
             break;
        case 0:
            state_door = STATE_DOOR_CLOSED;
            OPTION_REGbits.INTEDG = !0;
            NewDoorPolarity = 0;
            DoorStateBeforePrel = 0;
            break;
        }

    while (1) {

        if (NewStateChangeDetected == 1) {
        ...
        if (state_machine != write2display_copy) {
            if (state_machine != 12) {
                int2bcd('0', state_machine);

                write2display_copy = state_machine;
            }
        }
...
# 391 "main.c"
    if (duty_cycle == 0) {
        ...
        scaled_duty_cycle = 1024 / 100 * duty_cycle;
        CCPR1L = (unsigned char) (scaled_duty_cycle >> 2);
        CCP1CONbits.DC1B = (0x03 & scaled_duty_cycle);
    }
    return;
}
